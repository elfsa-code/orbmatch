...
namespace ORB {
    ...
    {  
        ...
        /************************你需要完成的函数*************************************/
        UseHistConsistency(keypoints_1, keypoints_2, des_good_matches, good_matches);
        cv::Mat good_img;
                                        ...
                                        std::vector<cv::DMatch>& good_matches)
    {
        ...
        for(int i=0; i<HISTO_LENGTH; i++)
        {
            // 如果特征点的旋转角度变化量属于这三个组，说明符合整体运动趋势，属于内点匹配对
